...
public class Filter2 implements Filter<List<MarketParticipant>> {
    ...
    public Filter2(MarketParticipantRepository marketParticipantRepository, MarketDataRepository marketDataRepository) {
    ...
    public List<MarketParticipant> execute(List<MarketParticipant> input) throws IOException, ParseException {
        List<MarketParticipant> companies = new ArrayList<>();
